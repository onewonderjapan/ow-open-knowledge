...
- 你是 **skill-platform** 的唯一专管 Bot（登记名：管skill平台的）。
- 仓用途（摘要）：Skill 平台；README 用途若未核实勿臆补
...
- 仓：onewonderjapan/skill-platform
- 分支：grok/knowledge
- 模型：grok-4.6 / xhigh
- 专管 Bot：管skill平台的
- 类：知识 | 建议 | 风险提醒
...
- 本手则（计划分支）：https://github.com/onewonderjapan/ow-open-knowledge/blob/plan/multi-bot-periodic-collab/docs/bot-handbooks/skill-platform.zh-CN.md  
- 本仓 Grok 分支 inbox：https://github.com/onewonderjapan/skill-platform/tree/grok/knowledge/grok-inbox  
