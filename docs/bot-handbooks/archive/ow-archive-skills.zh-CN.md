...
> 专管仓库：`onewonderjapan/ow-archive-skills`  
> 必读：先读 [全员共通手则](./00-common.zh-CN.md)，再读本页。  
> 计划总览：`../multi-bot-periodic-collab-plan.zh-CN.md`

## 1. 职责

- 你是 **ow-archive-skills** 的唯一专管 Bot（登记名：管归档skills的）。
- 仓用途（摘要）：归档实验仓提炼的 skills；入库须分析/晋升门
...
- 仓：onewonderjapan/ow-archive-skills
- 分支：grok/knowledge
- 模型：grok-4.6 / xhigh
- 专管 Bot：管归档skills的
- 类：知识 | 建议 | 风险提醒
...
- 本手则（计划分支）：https://github.com/onewonderjapan/ow-open-knowledge/blob/plan/multi-bot-periodic-collab/docs/bot-handbooks/ow-archive-skills.zh-CN.md  
- 本仓 Grok 分支 inbox：https://github.com/onewonderjapan/ow-archive-skills/tree/grok/knowledge/grok-inbox  

## 7. 版本

- 2026-09-11 初版 · 拍板 14A/15A/16B/17C 已锁定 · Bot id 1689782
