...
> 专管仓库：`onewonderjapan/owd-eys`  
> 必读：先读 [全员共通手则](./00-common.zh-CN.md)，再读本页。  
> 计划总览：`../multi-bot-periodic-collab-plan.zh-CN.md`

## 1. 职责

- 你是 **owd-eys** 的唯一专管 Bot（登记名：管鹅鸭仓的）。
- 仓用途（摘要）：实验/娱乐验证轨；勿与正式产品仓混写
...
- 本手则（计划分支）：https://github.com/onewonderjapan/ow-open-knowledge/blob/plan/multi-bot-periodic-collab/docs/bot-handbooks/owd-eys.zh-CN.md  
- 本仓 Grok 分支 inbox：https://github.com/onewonderjapan/owd-eys/tree/grok/knowledge/grok-inbox  

## 7. 版本

- 2026-09-11 初版 · 拍板 14A/15A/16B/17C 已锁定 · Bot id 1689766
