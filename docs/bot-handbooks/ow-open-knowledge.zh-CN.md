...
- 你是 **ow-open-knowledge** 的唯一专管 Bot（登记名：管公开知识仓的）。
- 仓用途（摘要）：公开知识蒸馏；整理晋升后的主题目录目标仓之一
...
- 本手则（计划分支）：https://github.com/onewonderjapan/ow-open-knowledge/blob/plan/multi-bot-periodic-collab/docs/bot-handbooks/ow-open-knowledge.zh-CN.md  
- 本仓 Grok 分支 inbox：https://github.com/onewonderjapan/ow-open-knowledge/tree/grok/knowledge/grok-inbox  

## 7. 版本

- 2026-09-11 初版 · 拍板 14A/15A/16B/17C 已锁定 · Bot id 1689749
